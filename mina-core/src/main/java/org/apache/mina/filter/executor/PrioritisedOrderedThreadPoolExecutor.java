 ...
 */
// TODO this class currently copies OrderedThreadPoolExecutor, and changes the BlockingQueue used for the waitingSessions field. This code duplication should be avoided.
public class PrioritisedOrderedThreadPoolExecutor extends ThreadPoolExecutor
{
     ...
     */
    public PrioritisedOrderedThreadPoolExecutor() {
     ...
     */
    public PrioritisedOrderedThreadPoolExecutor( int maximumPoolSize) {
     ...
     * @param maximumPoolSize The maximum pool size
     */
    public PrioritisedOrderedThreadPoolExecutor( int corePoolSize, int maximumPoolSize) {
     ...
     */
    public PrioritisedOrderedThreadPoolExecutor( int corePoolSize, int maximumPoolSize, long keepAliveTime, TimeUnit unit) {
    ...
    private class Worker implements Runnable
    {
        ...
        public void run() {
            ...
            try {
                ...
                synchronized (workers) {
                    workers.remove(this);
                    PrioritisedOrderedThreadPoolExecutor.this.completedTaskCount += completedTaskCount.get();
                    workers.notifyAll();
                }
            }
        }
        ...
        private void runTasks(SessionTasksQueue sessionTasksQueue) {
            for (;;) {
                ...
                eventQueueHandler.polled( PrioritisedOrderedThreadPoolExecutor.this, (IoEvent) task);
